...
public sealed class DownstreamGateEvaluator : IDownstreamGateEvaluator
{
    ...
    private GateEvaluationResult EvaluateRequirementsGate(JsonElement root, int hardInvalidCount, int softQualityCount)
    {
    ...
    private static void AddMetric(List<GateMetricResult> metrics, List<string> reasons, string metricKey, string @operator, int actual, int expected, bool passed, string failureMessage)
    {
    ...
    private static void AddMetric(List<GateMetricResult> metrics, List<string> reasons, string metricKey, string @operator, double actual, double expected, bool passed, string failureMessage)
    {
        metrics.Add(new GateMetricResult
        {
            MetricKey = metricKey,
    ...
    private static int CountItems(string? json, string arrayPropertyName)
    {
        ...
        using (document)
        {
            return document.RootElement.TryGetProperty(arrayPropertyName, out var items) && items.ValueKind == JsonValueKind.Array
