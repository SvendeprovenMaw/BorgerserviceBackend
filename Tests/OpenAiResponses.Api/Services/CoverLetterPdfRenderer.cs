...
/// <summary>
/// Produces a one-page A4 PDF from the structured application-generation document.
/// </summary>
public sealed class CoverLetterPdfRenderer : ICoverLetterPdfRenderer
{
    ...
    /// <summary>
    /// Generates a single-page PDF artifact that matches the existing cover-letter layout intent.
    /// </summary>
